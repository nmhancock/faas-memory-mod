...
import (
	...
	"github.com/nmhancock/faas-memory-mod/handlers"
	"github.com/nmhancock/faas-memory-mod/types"
	"github.com/nmhancock/faas-memory-mod/version"
...
func main() {
	...
	log.Infof("faas-memory-mod version:%s. Last commit message: %s, commit SHA: %s'", version.BuildVersion(), version.GitCommitMessage, version.GitCommitSHA)
